...
export default function Contact() {
    return (
        <div style={{ 'backgroundImage': `url('https://images.unsplash.com/photo-1534536281715-e28d76689b4d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y29udGFjdHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60')` }} className="container w-full my-5 p-20 bg-cover bg-no-repeat h-screen">
